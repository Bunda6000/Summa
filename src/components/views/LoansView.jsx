...
export default function LoansView({ loanTypes, getLoanAmountForMonth, expYear, setExpYear, onAdd, onUpdate, onDelete, loanPaid, toggleLoanPaid, setLoanPaidDate, toggleAllLoansPaid, paidPicker, setPaidPicker }) {
